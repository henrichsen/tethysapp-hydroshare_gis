...
def get_search_results(search_input, page):
    start = (int(page) - 1) * 15
    gen = HydroShare().resources(type=['RasterResource', 'GeographicFeatureResource'], full_text_search=str(search_input), start=start, count=16)
    gen_list = list(gen)
